...
export const ProductItemImage = styled.div`
  ...
  img {
    ...
    object-fit: contain;
    vertical-align: bottom; //canh cho bang phan duoi voi cac thanh phan khac
  }
`
...
export const ProductItemTitle = styled.div`
  ...
  overflow: hidden;
  text-overflow: ellipsis; //dau 3 cham neu doan van qua dai
  -webkit-box-orient: vertical; //Định dạng thành phần từ trên xuống dưới theo chiều dọc.
  -webkit-line-clamp: 2; //hien thi 2 hang
  font-size: 1.2rem;
  line-height: 1.4rem;
